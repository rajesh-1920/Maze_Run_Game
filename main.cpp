...
void Display()
{
    ...
    settextstyle(4,4,1);
    setcolor(LIGHTRED);
    outtextxy(140,280,": Life -1");
    t1=20;
    t2=297;
    outtextxy(150,310,": Life +1");
    setcolor(RED);
    ...
    setcolor(6);
    outtextxy(150,375,"if(Life==0)");
    outtextxy(165,400,"Game Over");
